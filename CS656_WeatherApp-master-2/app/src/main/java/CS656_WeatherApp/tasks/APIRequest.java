package CS656_WeatherApp.tasks;
...
public abstract class APIRequest extends AsyncTask<String, String, TaskOutput> {
    ...
    public APIRequest(Context context, MainActivity activity, ProgressDialog progressDialog) {
    ...
    private URL provideURL(String[] reqParams) throws UnsupportedEncodingException, MalformedURLException {
        ...
        String apiKey = "45bcd2fdd56d99fafce230e5b90e2801";
        ...
        if (reqParams.length > 0) {
            ...
            final String cityId = sp.getString("cityId", DefaultCity.DEFAULT_CITY_ID);
